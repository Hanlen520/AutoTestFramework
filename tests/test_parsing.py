...
class TestParsing(unittest.TestCase):
    ...
    def test_unicode_templating(self):
        ...
        self.assertEqual('my name is 指 and my value is 汉', substituted)
        ...
        self.assertEqual('my normal name is blah and my unicode name is 汉', substituted)
        ...
        self.assertEqual('my name is 指 and my value is bob', substituted)
